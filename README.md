...
A passionate **Software Engineering student** with expertise in **Flutter mobile development** and **full-stack web applications**. I've successfully completed 4 semesters at Aptech, building robust applications using modern technologies. Eager to apply my skills in a challenging junior developer role at a forward-thinking company.
...
**Modern Career Guidance Platform**
- **Tech:** Flutter, Firebase, Cloudinary Integration
...
*Advanced Diploma in Software Engineering (Prime 2.0)* | *2023 – 2026*

**Completed Semesters:**
- **Semester 4:** Flutter Cross-Platform Development, Azure Cloud, Agile & DevOps
- **Semester 3:** ASP.NET Core MVC, Angular, SQL Server
- **Semester 2:** PHP Laravel, MySQL Web Applications
- **Semester 1:** Frontend Development (HTML5, CSS3, JavaScript, Bootstrap)
